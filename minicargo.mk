...
# `std::env::consts::ARCH` - override for a cross build, the host's arch isn't the target's
STD_ENV_ARCH ?= $(RUSTC_ARCH)
...
LIBS: $(RUSTCSRC)mrustc-stdlib/Cargo.toml $(MRUSTC) $(MINICARGO)
	+STD_ENV_ARCH=$(STD_ENV_ARCH) $(MINICARGO) --vendor-dir $(VENDOR_DIR) --script-overrides $(OVERRIDE_DIR) --output-dir $(OUTDIR) $(MINICARGO_FLAGS) $(RUSTCSRC)mrustc-stdlib/
